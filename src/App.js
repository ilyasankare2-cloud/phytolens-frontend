        ...
        {result && cfg && (
          <div style={{...styles.result, borderColor:cfg.color}}>
            <div style={styles.resultHeader}>
              ...
              <div>
                <p style={{...styles.resultLabel, color:cfg.color}}>{cfg.text}</p>
            ...
            <div style={styles.bars}>
              {Object.entries(result.all_probs).map(([key, val]) => (
                <div key={key} style={styles.barRow}>
                  <span style={styles.barLabel}>{LABELS[key].text}</span>
...
const styles = {
  ...
  barLabel:      { color:'#aaa', fontSize:12, width:120, flexShrink:0 },
